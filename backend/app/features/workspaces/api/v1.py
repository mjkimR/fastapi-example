...
from app.features.workspaces.schemas import WorkspaceRead, WorkspaceUpdate, WorkspaceCreate
...
async def delete_workspace(
    ...
    if not await use_case.execute(workspace_id, context={"user_id": current_user.id}):
        raise NotFoundException()
