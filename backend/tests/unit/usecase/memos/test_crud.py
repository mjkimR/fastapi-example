...
from backend.app.features.memos.schemas import MemoCreate, MemoUpdate
from backend.app.features.memos.usecases.crud import (
    CreateMemoUseCase,
    GetMemoUseCase,
    GetMultiMemoUseCase,
    UpdateMemoUseCase,
...
def patch_async_transaction(mocker, mock_session):
    ...
    mock_async_transaction = mocker.patch("app.usecases.base.crud.AsyncTransaction")
...
def patch_memo_async_transaction(mocker, mock_session):
    """Fixture to patch AsyncTransaction for memo usecases."""
    mock_async_transaction = mocker.patch("app.usecases.memos.crud.AsyncTransaction")
    mock_async_transaction.return_value.__aenter__.return_value = mock_session
    return mock_async_transaction
