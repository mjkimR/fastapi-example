...
# Modules to test
from app_kit.ai.models.factory import AIModelFactory, ConfigLoader
from app_kit.ai.models.schemas import AIModelItem
...
def mock_schemas():
    ...
    with patch.dict(
        "sys.modules",
        {
            "app_kit.base.models.schemas": MagicMock(
