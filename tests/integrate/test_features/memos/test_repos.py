"""
Integration tests for MemoRepository.
...
class TestMemoRepositoryIntegration:
    """Integration tests for MemoRepository with real database."""
    ...
    @pytest.mark.asyncio
    async def test_create_memo(self, session: AsyncSession, repo: MemoRepository, single_workspace, regular_user):
    ...
    @pytest.mark.asyncio
    async def test_get_multi_memos_with_offset(self, session: AsyncSession, repo: MemoRepository, sample_memos: list[Memo]):
    ...
    @pytest.mark.asyncio
    async def test_get_memo_with_where_clause(self, session: AsyncSession, repo: MemoRepository, sample_memos: list[Memo]):
    ...
    @pytest.mark.asyncio
    async def test_update_memo_partial(self, session: AsyncSession, repo: MemoRepository, single_memo: Memo, admin_user):
