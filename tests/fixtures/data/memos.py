...
async def sample_memos(session: AsyncSession, single_workspace: Workspace, regular_user: User) -> list[Memo]:
...
@pytest_asyncio.fixture
async def single_memo(session: AsyncSession, single_workspace: Workspace, regular_user: User) -> Memo:
